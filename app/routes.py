from app import app, db #app module, import app variable
from flask import render_template, url_for, redirect, flash, request
from app.forms import LoginForm, RegistrationForm, ProfileUpdateForm, AdminSearchForm, AdminUpdateForm, AddNewUserForm, AdminDeleteForm
